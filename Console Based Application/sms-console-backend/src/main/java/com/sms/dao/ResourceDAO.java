...
//Author: Shobana V and Jothika R

/*
* This class for the query logic of a classroom and subject based on create, update, select and delete classroom/subject
*/
...
public class ResourceDAO {
	...
	public List<ClassRoom> getAllClassRooms() {
		...
		try {
			...
			while (rs.next()) {
				list.add(new ClassRoom(rs.getLong("id"), rs.getString("class_name"), rs.getString("section"),
						rs.getInt("capacity"), rs.getString("academic_year")));
			}
	...
	public List<Subject> getAllSubjects() {
		...
		try {
			...
			while (rs.next()) {
				list.add(new Subject(rs.getLong("subject_id"), rs.getString("subject_name"),
						rs.getString("subject_code"), rs.getLong("class_id")));
			}
